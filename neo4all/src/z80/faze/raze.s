...
!define(`SINGLE_MEM_BLOCK')         ! treat memory map as a whole block
             ! fetch opcodes from a single memory block
...
!	ifelse(op,`add',`mov #FLG_iV,zF',`mov #(FLG_iV | FLG_N),zF')
	...
	! TODO: emulate undoc
		...
		! H flag calculation
		mov r13,r2    ! DIRT_REG = reload first operand
		xor r0,r2                   ! xor first operand - result
		xor r1,r2        ! xor second operand
		shlr16 r2
		shlr8 r2
		mov #0x10,r1
		and r1,r2
...
_z80_reset:
	...
	mov.l _z80_IFF1_474,r2
	mov.w r0,@r2    ! Loads zero in zIFF1 and zIFF2
	mov.l _z80_IM_474,r2
	mov.b r0,@r2    ! IM = 0
	mov.l _z80_I_474,r2
	mov.b r0,@r2    ! I = 0
	mov.l _z80_R_474,r2
	mov.b r0,@r2    ! R = 0
	mov.l _z80_IRQLine_474,r2
	mov.b r0,@r2    ! IRQLine = 0
	mov.l _z80_halted_474,r2
	rts
	mov.b r0,@r2    ! halted = 0

	.align 2
	context_start_reset: .long context_start
	_z80_IFF1_474: .long _z80_IFF1
	_z80_IM_474: .long _z80_IM
	_z80_I_474: .long _z80_I
	_z80_R_474: .long _z80_R
	_z80_IRQLine_474: .long _z80_IRQLine
	_z80_halted_474: .long _z80_halted
